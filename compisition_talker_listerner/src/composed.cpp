...
#include "compisition_talker_listerner/subscriber_node.hpp"
#include "rclcpp/rclcpp.hpp"

/*
1 先将 publisher_node， subscriber_node 俩个.cpp文件生成库文件，在Cmakelist上操作
2 
...
int main(int argc, char * argv[])
{
  ...
  rclcpp::executors::SingleThreadedExecutor exec;//将所有节点打包到一个线程中运行
